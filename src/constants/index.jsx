export const servicesMission = [
    {
        id: "0",
        icon: "/images/feature-1.png",
        caption: "Our Services",
        title: "Sleep easy, we got your back",
        text: "We provide a comprehensive suite of assurance services designed to seamlessly integrate robust security practices into your organization’s " +
            "core processes. Our offerings include ISO 27001 Implementation & Auditing, which helps businesses establish and maintain effective Information " +
            "Security Management Systems (ISMS); GDPR Compliance, ensuring your data protection measures meet the stringent requirements of the regulation; " +
            "and ISO 20000 Implementation & Auditing, aligning your IT service management processes with international standards. ",
        button: {
    ...
    },
    {
        ...
        caption: "Our Mission:",
        title: "Empowering Cybersecurity: Simplifying Compliance, Securing Trust",
        text: "Our mission is to empower businesses to achieve cybersecurity compliance effortlessly, while embedding security best practices into their " +
            "everyday operations. We are dedicated to guiding businesses through the complex landscape of compliance, helping them secure their data, " +
            "protect their customers, and build trust.",
        button: {
...
export const faq = [
    {
        id: "0",
        question: "What cybersecurity assurance services do you offer?",
        answer:
            "At Cyber Compliance Hub, we provide a comprehensive suite of services—including ISO 27001, ISO 27017, ISO 27018, and ISO 27701 implementations and audits, GDPR compliance, and ISO 20000 IT service management auditing—to help you stay secure and compliant.",
    },
    {
        id: "1",
        question: "How do you ensure compliance and robust security?",
        answer:
            "Our team of experts employs industry best practices and globally recognized standards to design and implement customized cybersecurity frameworks, ensuring your organization is both secure and compliant.",
    },
    {
        id: "2",
        question: "Which industries and business sizes do you support?",
        answer:
            "We serve a diverse range of clients—from small startups to large global enterprises—delivering tailored solutions that address the unique security and compliance needs of every organization.",
    },
    {
        id: "3",
        question: "What sets Cyber Compliance Hub apart from other providers?",
        answer:
            "Our proven track record, highlighted by a 100% external audit pass rate, combined with our comprehensive expertise and personalized approach, makes us a trusted partner in cybersecurity and compliance.",
    },
    {
        id: "4",
        question: "How long does it take to implement an ISO standard?",
        answer:
            "The timeline can vary depending on your organization’s size and complexity. Our experts work closely with you to streamline the process and ensure a smooth transition to full compliance.",
    },
    {
        id: "5",
        question: "Do you offer ongoing support after implementation?",
        answer:
            "Yes. We provide continuous post-implementation support to help you maintain compliance, adapt to evolving cybersecurity challenges, and ensure that your security framework remains up-to-date.",
    },
    {
        id: "6",
        question: "Can you help us achieve GDPR compliance?",
        answer:
            "Absolutely. Our GDPR compliance services are designed to help you navigate the complexities of data protection regulations, safeguarding personal data and ensuring adherence to all relevant regulatory requirements.",
    },
    {
        id: "7",
        question: "What is your approach to securing cloud environments?",
        answer:
            "We specialize in ISO 27017 and ISO 27018 standards, which ensure that your cloud security practices are optimized for data protection and compliance, addressing both infrastructure and personal data needs.",
    },
    {
        id: "8",
        question: "How do you tailor solutions for each business?",
        answer:
            "Understanding that every organization is unique, we customize our approach to align with your specific goals, industry requirements, and regulatory obligations, ensuring an optimal security posture.",
    },
    {
        id: "9",
        question: "How does Cyber Compliance Hub help us stay ahead in cybersecurity?",
        answer:
            "By integrating comprehensive cybersecurity assurance services with ongoing support and continuous improvement strategies, we ensure your organization is not only compliant today but also prepared to meet future challenges.",
    },
];
...
export const plans = [
    {
        ...
        caption: "Expertise You Can Trust",
        description:
            "With years of experience, we are well-versed in the most widely recognized cybersecurity and compliance standards.",
    },
    {
        id: "1",
        ...
        description:
            "We are proud to have a 100% external audit pass rate, a testament to our commitment to excellence and quality in every project.",
    },
    {
        id: "2",
        title: "Customized Solutions",
        caption: "Customized Solutions",
        description:
            "We understand that every business is unique. Our solutions are designed to align with your specific goals, industry, and compliance requirements.",
    },
];
...
export const testimonials = [
    {
        ...
        role: "Chief Information Security Officer, Globalnomads",
        avatarUrl: "/images/testimonials/jessica-saunders.png",
        comment:
            "Cyber Compliance Hub transformed our approach to security by implementing a robust ISO 27001 framework. Their deep expertise has given us complete confidence in our data protection and overall compliance.",
    },
    {
        id: "1",
        name: "Mark Erixon",
        role: "CTO, Vid Capital International",
        avatarUrl: "/images/testimonials/mark-erixon.png",
        comment:
            "Their tailored cybersecurity solutions and exceptional auditing processes made achieving GDPR compliance and strengthening our cloud security effortless. The team exceeded our expectations.",
    },
    {
        id: "2",
        name: "Melanie Hurst",
        role: "Chief Security Officer, CyberLeap",
        avatarUrl: "/images/testimonials/melanie-hurst.png",
        comment:
            "Partnering with Cyber Compliance Hub was a game-changer. Their ISO 27017 and ISO 27018 implementations significantly enhanced our cloud data protection, ensuring both security and compliance.",
    },
    {
        id: "3",
        name: "Alicia Barker",
        role: "Privacy & Compliance Manager, CyberLeap",
        avatarUrl: "/images/testimonials/alicia-barker.png",
        comment:
            "Their expertise in ISO 27701 and GDPR compliance streamlined our privacy management process. Cyber Compliance Hub simplified complex regulations, making our compliance journey seamless.",
    },
    {
        id: "4",
        name: "Becky Snider",
        role: "IT Director, Floclips",
        avatarUrl: "/images/testimonials/becky-snider.png",
        comment:
            "Since partnering with Cyber Compliance Hub, our cybersecurity posture has improved significantly. Their customized approach and consistent support ensure we’re always audit-ready.",
    },
    {
        id: "5",
        name: "Jim Bradley",
        role: "Head of Security, Vid Capital International",
        avatarUrl: "/images/testimonials/jim-bradley.png",
        comment:
            "Cyber Compliance Hub’s comprehensive approach not only helped us achieve a 100% external audit pass rate but also built a resilient security culture within our organization.",
    },
];
